...
public class FirebaseTokenHelper {
    ...
    public static String getFirebaseToken() throws InvocationTargetException, IllegalAccessException,
        ...
        try {
            ...
            Method getToken = FirebaseInstanceId.class.getDeclaredMethod("getToken", args);
            return (String) getToken.invoke(FirebaseInstanceId.getInstance(), Pushwoosh.getInstance().getSenderId(), "FCM");
