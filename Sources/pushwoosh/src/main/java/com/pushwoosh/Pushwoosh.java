...
public class Pushwoosh {
     ...
     *           String customData = launchNotification.getCustomData();
     *           String screen = null;
     ...
     *                   screen = data.optString("screen");
     *                   productId = data.optString("product_id", null);
     *                   articleId = data.optString("article_id", null);
