...
public class PushStatEventTest {
    ...
    // Test data
    private static final String TEST_HASH = "test_hash_789";
    private static final String TEST_HASH_RETRY = "test_hash_retry_890";
    private static final String TEST_METADATA = "test_metadata_open";
    private static final String TEST_PUSH_TITLE = "Test Push Open";
    private static final String TEST_PUSH_MESSAGE = "This is a integration test push open message";
    ...
    private Bundle createTestPushBundle() {
        return createTestPushBundle(TEST_HASH);
    }

    private Bundle createTestPushBundle(String hash) {
        Bundle bundle = new Bundle();
        bundle.putString("p", hash);
    ...
    /**
     * Verifies that push stat event flow successfully sends push stat request.
     * Tests basic push open statistics tracking functionality.
     */
    @Test
    ...
    /**
     * Verifies that push stat event retries on server errors (5xx).
    ...
    /**
     * Verifies that push stat event does not retry on client errors (4xx).
